            ...
            <Container>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="ms-auto">
                        <Link className='text-decoration-none text-black fw-semibold fs-5'>Home</Link>
                        <Link className='text-decoration-none text-black fw-semibold fs-5 mx-3'>Blog</Link>
                    </Nav>
                    <Nav>
